...
cbar = fig.colorbar(c, ticks=[min(field[0]), 0, max(field[0])])
...
plt.legend()
plt.tight_layout()
plt.savefig('./Figures/1-1-ChampPression.png', facecolor='w', edgecolor='w')
#------------------------------------------------------------------------------#
...
x, y = antenne.coordinates()
source = da.PlaneWave(ang=np.pi/12)
...
ax1.grid()
plt.tight_layout()
plt.savefig('./Figures/1-2-PressionMicros.eps', facecolor='w', edgecolor='w')
#------------------------------------------------------------------------------#
...
plt.tight_layout()
plt.savefig('beam.eps', facecolor='w', edgecolor='w')
plt.show()
"""
#------------------------------------------------------------------------------#
...
plt.legend(loc='upper right', bbox_to_anchor=(1.3, 1))
plt.tight_layout()
plt.savefig('./Figures/2-2-ModelisationExp.svg', facecolor='w', edgecolor='w')
...
plt.tight_layout()
plt.savefig('./Figures/3-1-ModuleFiltres.svg', facecolor='w', edgecolor='w')
#------------------------------------------------------------------------------#
"""
"""
#------------------------------------------------------------------------------#
...
plt.legend()
plt.tight_layout()
plt.savefig('./Figures/3-2-Interpolation.svg', facecolor='w', edgecolor='w')
#------------------------------------------------------------------------------#
"""
"""
#------------------------------------------------------------------------------#
...
plt.legend()
plt.tight_layout()
plt.savefig('./Figures/3-3-ImpulseResponse.svg', facecolor='w', edgecolor='w')
""""""
#------------------------------------------------------------------------------#
"""
"""
...
plt.legend(loc='upper right', bbox_to_anchor=(1.3, 1))
plt.tight_layout()
plt.savefig('./Figures/3-4-OutputSignals.eps', facecolor='w', edgecolor='w')
"""
#------------------------------------------------------------------------------#
plt.show()
